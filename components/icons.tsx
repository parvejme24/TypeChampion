...
/** Navbar profile menu — account / settings link */
export const ProfileSettingsIcon = ({ size = 18, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
/** Navbar profile menu — typed history / list */
export const ProfileTypedListIcon = ({ size = 18, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
/** Navbar profile menu — admin users */
export const ProfileUsersIcon = ({ size = 18, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
/** Navbar profile menu — paragraphs / documents */
export const ProfileDocumentIcon = ({ size = 18, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
/** Navbar profile menu — sign out */
export const ProfileLogoutIcon = ({ size = 18, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
